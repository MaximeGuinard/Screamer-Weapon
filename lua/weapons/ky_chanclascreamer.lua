...
SWEP.PrintName				= "Chancla-Screamer"			
SWEP.Author					= "Kayxy"
...
if trace.Entity:IsPlayer() then
	trace.Entity:SetNWBool("chancla", true)
	trace.Entity:EmitSound("screamersound/criescreamer.wav")
	timer.Simple(4, function() trace.Entity:SetNWBool("chancla", false) end)
end
timer.Simple(4, function() trace.Entity:SetNWBool("chancla", false) end)
...
function SWEP:SecondaryAttack()
	...
	if self.Owner:IsPlayer() then
		self.Owner:SetNWBool("chancla", true)
		self.Owner:EmitSound("screamersound/criescreamer.wav")
		timer.Simple(4, function() self.Owner:SetNWBool("chancla", false) end)
	end
