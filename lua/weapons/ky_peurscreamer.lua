...
if trace.Entity:IsPlayer() then
	trace.Entity:SetNWBool("peurscream", true)
	trace.Entity:EmitSound("screamersound/criescreamer.wav")
	timer.Simple(4, function() trace.Entity:SetNWBool("peurscream", false) end)
end
timer.Simple(4, function() trace.Entity:SetNWBool("peurscream", false) end)
...
function SWEP:SecondaryAttack()
	...
	if self.Owner:IsPlayer() then
		self.Owner:SetNWBool("peurscream", true)
	self.Owner:EmitSound("screamersound/criescreamer.wav")
		timer.Simple(4, function() self.Owner:SetNWBool("peurscream", false) end)
	end
